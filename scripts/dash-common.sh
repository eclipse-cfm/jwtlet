...
# Eclipse project this repository belongs to (https://projects.eclipse.org/projects/technology.cfm).
ECLIPSE_PROJECT_ID="${ECLIPSE_PROJECT_ID:-technology.cfm}"
ECLIPSE_PROJECT_REPO="${ECLIPSE_PROJECT_REPO:-https://github.com/eclipse-cfm/jwtlet}"
